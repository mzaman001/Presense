...
1. **Silent data loss (ROOT PATTERN 1)** — 37 of 71 Supabase mutations don't check `error`. `inbox/page.tsx` (BUG-34) was the canonical example — **fully fixed Aug 10, 2026** (see BUG-34 in `EXECUTION_SPEC.md`; root cause was migration 005 never applied to the live DB). Remaining worst offenders: `OnboardingWizard.tsx` (11 unchecked), `think/[id]/page.tsx`, `explore/[id]/page.tsx`, `remember/people/[id]/page.tsx`.
