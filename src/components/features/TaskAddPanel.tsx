      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed top-0 right-0 h-[100dvh] w-full md:top-3 md:right-3 md:h-[calc(100dvh-24px)] md:w-[480px] md:rounded-2xl bg-[var(--color-surface)] border-l md:border border-[var(--color-border)] z-50 flex flex-col shadow-2xl overflow-hidden"
          >
